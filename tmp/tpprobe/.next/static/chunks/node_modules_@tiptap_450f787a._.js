...
"[project]/node_modules/@tiptap/pm/dist/tables/index.js [app-client] (ecmascript) <module evaluation>": ((__turbopack_context__) => {
"use strict";
   ...
   */ createEditor() {
        ...
        const optionsToApply = {
            ...
            onMount: function() {
                ...
                var _a, _b;
                return (_b = (_a = _this.options.current).onMount) == null ? void 0 : _b.call(_a, ...args);
            },
            onUnmount: function() {
                for(var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++){
                    args[_key] = arguments[_key];
                ...
                var _a, _b;
                return (_b = (_a = _this.options.current).onUnmount) == null ? void 0 : _b.call(_a, ...args);
            }
        };
...
function isAllowedUri(uri, protocols) {
    ...
    return !uri || uri.replace(UNICODE_WHITESPACE_REGEX_GLOBAL, "").match(new RegExp("^(?:(?:".concat(allowedProtocols.map((protocol)=>protocol.replace(/[-/\\^$*+?.()|[\]{}]/g, "\\$&")).join("|"), "):|[^a-z]|[a-z0-9+.\\-]+(?:[^a-z+.\\-:]|$))"), "i"));
}
var Link = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Mark"].create({
    ...
    renderMarkdown: (node, h)=>{
        ...
        return title ? "[".concat(text, "](").concat(href, ' "').concat(title, '")') : "[".concat(text, "](").concat(href, ")");
    },
    addCommands () {
        return {
...
var createBranchingListDeleteKeymap = (itemName, wrapperNames)=>{
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Extension"].create({
        name: "".concat(itemName, "BranchingDeleteKeymap"),
        priority: 101,
        addKeyboardShortcuts () {
...
var ORDERED_LIST_MARKER_PATTERN = String.raw(_templateObject(), ORDERED_LIST_ALPHA_MARKER_PATTERN);
...
function getListMarker(type, index) {
    let separator = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : ". ";
    const position = index + 1;
    if (!type || type === "1") {
        return "".concat(position).concat(separator);
    }
    switch(type){
        case "a":
            return "".concat(toRomanAlpha(position)).concat(separator);
        case "A":
            return "".concat(toRomanAlpha(position).toUpperCase()).concat(separator);
        case "i":
            return "".concat(toRoman(position)).concat(separator);
        case "I":
            return "".concat(toRomanUpper(position)).concat(separator);
        default:
            return "".concat(position).concat(separator);
    }
}
...
var ORDERED_LIST_ITEM_REGEX = new RegExp("^(\\s*)(".concat(ORDERED_LIST_MARKER_PATTERN, ")([.)])\\s+(.*)$"));
...
var PLAIN_TEXT_ORDERED_LIST_LINE_REGEX = new RegExp("^(".concat(ORDERED_LIST_MARKER_PATTERN, ")([.)])\\s+(.+)$"));
        ...
        return (param)=>{
            ...
            return {
                ...
                update: (updatedNode)=>{
                    ...
                    Object.entries(newHTMLAttributes).forEach((param)=>{
                        let [key, value] = param;
...
function scanRangeForDecorations(param) {
    let { editor, options, dataAttribute, doc, selection, from, to } = param;
    const { anchor } = selection;
    const decorations = [];
...
function buildPlaceholderDecorations(param) {
    let { editor, options, dataAttribute, doc, selection } = param;
...
function updateDecorationsInRanges(param) {
    let { decorations, ranges, editor, options, dataAttribute, doc, selection } = param;
...
function createPlaceholderStateField(param) {
    let { editor, options, dataAttribute } = param;
    return {
        init (_config, state) {
...
function createPlaceholderPlugin(param) {
    let { editor, options } = param;
    const dataAttribute = options.dataAttribute ? "data-".concat(preparePlaceholderAttribute(options.dataAttribute)) : "data-".concat(DEFAULT_DATA_ATTRIBUTE);
    const useResolvedPath = options.showOnlyCurrent && !options.includeChildren;
    return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Plugin"]({
        key: PLUGIN_KEY,
        ...useResolvedPath ? {} : {
        ...
        props: {
            decorations: useResolvedPath ? (param)=>{
                let { doc, selection } = param;
...
"[project]/node_modules/@tiptap/extension-placeholder/dist/index.js [app-client] (ecmascript) <module evaluation>": ((__turbopack_context__) => {
"use strict";
...
var Image = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Node"].create({
    ...
    renderMarkdown: (node)=>{
        ...
        return title ? "![".concat(alt, "](").concat(src, ' "').concat(title, '")') : "![".concat(alt, "](").concat(src, ")");
    },
    addNodeView () {
        ...
        return (param)=>{
            let { node, getPos, HTMLAttributes, editor } = param;
            ...
            Object.entries(mergedAttributes).forEach((param)=>{
                let [key, value] = param;
                if (value != null) {
                    switch(key){
                        case "width":
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$pm$2f$dist$2f$state$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/node_modules/@tiptap/pm/dist/state/index.js [app-client] (ecmascript) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/prosemirror-state/dist/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$pm$2f$dist$2f$tables$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/node_modules/@tiptap/pm/dist/tables/index.js [app-client] (ecmascript) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$tables$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/prosemirror-tables/dist/index.js [app-client] (ecmascript)");
;
...
function createAlignAttribute() {
    return {
        ...
        renderHTML: (attributes)=>{
            ...
            return {
                style: "text-align: ".concat(attributes.align)
            };
        }
    };
}
...
function getColStyleDeclaration(minWidth, width) {
    if (width) {
        return [
            "width",
            "".concat(Math.max(width, minWidth), "px")
        ];
    }
    return [
        "min-width",
    ...
    if (row !== null) {
        for(let i = 0, col = 0; i < row.childCount; i += 1){
            ...
            for(let j = 0; j < colspan; j += 1, col += 1){
                ...
                const cssWidth = hasWidth ? "".concat(hasWidth, "px") : "";
...
function createColGroup(node, cellMinWidth, overrideCol, overrideValue) {
    ...
    const tableWidth = fixedWidth ? "".concat(totalWidth, "px") : "";
    const tableMinWidth = fixedWidth ? "" : "".concat(totalWidth, "px");
    const colgroup = [
        "colgroup",
        {},
        ...cols
...
var deleteTableWhenAllCellsSelected = (param)=>{
    let { editor } = param;
    const { selection } = editor.state;
    ...
    while(i < line.length){
        ...
        while(j < line.length){
            ...
            if (closeLen === runLen) {
                ...
                result += line.slice(i, i + runLen) + spanContent.replace(RegExp("(?<!\\\\)\\|", "g"), "\\|") + line.slice(j, j + runLen);
                i = j + runLen;
                found = true;
                break;
            }
...
function renderTableToMarkdown(node, h) {
    ...
    out += "| ".concat(headerTexts.map((t, i)=>pad(t, colWidths[i])).join(" | "), " |\n");
    out += "| ".concat(colWidths.map((w, index)=>{
        const dashCount = Math.max(3, w);
        const alignment = colAlignments[index];
        if (alignment === "left" /* Left */ ) {
            return ":".concat("-".repeat(dashCount));
        }
...
var Table = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Node"].create({
    ...
    renderHTML (param) {
        ...
        function getTableStyle() {
            ...
            return tableWidth ? "width: ".concat(tableWidth) : "min-width: ".concat(tableMinWidth);
        }
        const table = [
            "table",
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mergeAttributes"])(this.options.HTMLAttributes, HTMLAttributes, {
    ...
    addCommands () {
        return {
            insertTable: function() {
                let { rows = 3, cols = 3, withHeaderRow = true } = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
                return (param)=>{
            ...
            setCellAttribute: (name, value)=>(param)=>{
                    let { state, dispatch } = param;
            ...
            setCellSelection: (position)=>(param)=>{
                    let { tr, dispatch } = param;
                    if (dispatch) {
    ...
    addNodeView () {
        ...
        return (param)=>{
            let { node, view, HTMLAttributes } = param;
            const mergedAttributes = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mergeAttributes"])(this.options.HTMLAttributes, HTMLAttributes);
...
//# sourceMappingURL=node_modules_%40tiptap_450f787a._.js.map