      ...
      <main className="max-w-4xl mx-auto px-8 py-16">
        <div className="grid md:grid-cols-2 gap-16">
          <div className="space-y-8">
            <h1 className="text-4xl font-mono tracking-tight">ABOUT</h1>
            ...
            <div className="space-y-2 pt-8">
              <h2 className="font-mono text-sm tracking-wider mb-4">CONTACT</h2>
              <p className="text-sm">hello@example.com</p>
              <p className="text-sm">+82 10 1234 5678</p>
            </div>

            <div className="space-y-2 pt-8">
              <h2 className="font-mono text-sm tracking-wider mb-4">FOLLOW</h2>
        ...
        <section className="mt-24 space-y-8">
          <h2 className="text-2xl font-mono tracking-tight">SELECTED EXHIBITIONS</h2>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-3 gap-4 border-b pb-4">
              <span className="font-mono text-sm">2022</span>
        ...
        <section className="mt-24 space-y-8">
          <h2 className="text-2xl font-mono tracking-tight">PUBLICATIONS</h2>
