export default function Home() {
  return (
    <main className="min-h-screen bg-white px-6 py-12 md:py-20">
      <article className="mx-auto max-w-prose">
        ...
        <p className="mb-8">
          사진은 기억하고 싶은 순간들의 흔적이다. 빛과 그림자, 사람과 공간, 
          그 사이에서 발견한 이야기들을 모은다.
        </p>

        <p className="mb-8">
          때로는 글을 쓴다. 보이지 않는 것들에 대해서. 
        ...
        <p className="mb-8">
          음악을 들으며 걷는다. 도시의 리듬과 나의 발걸음이 
          만나는 지점. 플레이리스트는 계절마다 바뀐다.
        </p>
