...
그런데 메이커 스프린트 1기에 참여하신 [@최수민](https://disquiet.io/@greatsumini) 님은 미리 만들어진 UI와 기능을 조합해서 원하는 CRM/ERP를 만들 수 있는 프레임워크인 토니를 만들며 이런 시도를 하셨습니다.

- 우선, 시장에 진입하기 전에 직접 고객이 되어 업계 사람들이 고객에게 어떤 제안을 하는지 파악했습니다. 이 과정에서 제품개발의 범위까지 정할 수 있었습니다.
- 그 다음 외주를 반복하며 완성된 제품이 없어도 고객을 만나고 매출까지 발생시켰습니다.
- 만약 고객의 IT 친숙도가 낮아서 세일즈에 어려움을 겪는다면 세 가지를 기억하세요. 고객이 가장 두려워하는 문제를 이해하기, 전문가의 인용문구, 최소 2~3개의 실제사례. **수민님은 이 세 가지로 세일즈 전환율을 이전 대비 60% 개선했습니다.**

이외에도 B2B SaaS를 만드는 초기 팀이 참고할 수 있는 몇 가지 GTM 팁을 공유해주셨습니다. 이번 글에 정리해봤습니다 :)

## 패션 스타트업 창업 → 외주사 창업 → 토스 입사

![0_핔UI.jpg](/images/uploads/disquiet-sumin-day1-revenue-1.jpg "0_핔UI.jpg")

// 대학교 때 창업한 패션 스타트업

대학교 때가 첫 창업이었어요. 패션을 좋아해서 패션 스타트업을 창업했습니다. 그렇게 약 2년 반 동안 회사를 운영하면서 월 매출을 2억까지 달성하고 시드투자까지 받았지만, 당시의 무신사와 29CM가 엄청난 프로모션으로 많은 고객을 획득하면서 사업을 접게 되었어요.
...
![Screenshot 2024-07-02 at 10.39.15 AM.png](/images/uploads/disquiet-sumin-day1-revenue-2.png "Screenshot 2024-07-02 at 10.39.15 AM.png")// 외주를 진행했던 아지트
...
- CRM을 사용하는 사람들의 IT 친숙도가 떨어지기 때문에 외부 제품을 사용하면 러닝커브가 높음. 그래서 자체 CRM과 매뉴얼을 만들어 주입식 교육을 할 수 있어야 함
...
1. **고객을 만나는 시점을 앞당길 수 있어요.** SaaS는 특성상 제품이 개발되지 않았거나, 고객이 필요로하는 기능이 없는 경우 세일즈가 어려워지는데요. 외주는 구현자유도가 높기 때문에 다양한 고객을 당장 만족시킬 수 있어요. 게다가 돈을 낼 준비가 된 유저들이기 때문에 핵심적인 문제가 무엇인지 바로 말해줍니다.
2. **병렬적으로 제품개발도 가능합니다.** 현재의 토니는 라이브러리인데요, 외주개발을 진행하면서 토니를 활용해 제품개발을 진행하고, 토니에 없는 기능이 필요하면 그때그때 개발해 공급하고 있습니다. 이때 새로 개발한 것의 활용가치가 높다고 판단되면 토니에 추가하는 식으로 제품을 고도화시키고 있어요.
3. **마지막으로 방향성에 대한 감을 잡을 수 있어요.** 저는 처음에 버블같은 노코드 SaaS를 만들어야한다는 생각이 들었는데요, 타겟 고객을 만나 이야기를 나누다보니 SaaS를 당장 만들 필요가 없다는 쪽으로 생각이 기울면서 방향성을 잡게 되었어요.

반대로 외주를 반복할 때의 단점도 있는데요. 장단점을 모두 이해한 상태에서 외주를 진행해야 함정에 빠지지 않을 수 있어요. 외주의 단점은 아래와 같아요.

1. 요구사항을 잘 조율하지 못하면 고객의 지엽적인 요구사항을 대응하는데 시간을 빼앗길 수 있어요.
2. 한 번에 대응할 수 있는 고객 수가 적어요. 외주 특성 상 고객 한 명 한 명에 매우 깊게 관여하며 소통/개발을 하다보니 시간소모가 커요. 그래서 저는 지금 최대 3팀까지만 수주하고 있어요.
3. 맥락 전환이 잦아 혼란스러울 수 있어요. 제품개발과 외주 프로젝트를 병행하다보니 집중력이 분산되는 것이죠.
...
![개인정보보안장표.png](/images/uploads/disquiet-sumin-day1-revenue-3.png "개인정보보안장표.png")// 개인정보보안과 관련한 불안을 해결하기 위해 개선한 세일즈덱
...
![일하는중 1.png](/images/uploads/disquiet-sumin-day1-revenue-4.png "일하는중 1.png")현재 거의 1인 개발로 외주와 제품개발을 진행하고 있는데요, 그래서 제가 어느 수준에서 과부하가 오는지 알기 위해 최대한 많은 의뢰를 받고 있습니다. 그리고 이 지점을 파악해서 재무적 지표를 기획한 다음 어떻게 비즈니스를 스케일할 수 있을지 계획하려 해요.
...
정리하면, 현재는 고객을 모으는 것에 집중하고 있어요. 더 많은 고객과 이야기 나누며 마켓에 대한 이해도와 제품의 수준을 높이고 싶습니다.
