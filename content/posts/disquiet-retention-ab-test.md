...
---
초기 팀은 많은 포지션보다, 많은 실행횟수가 더 중요합니다. 때문에 [직군을 나눠 일하는 것보다 모두가 각자의 장점을 살려 효율적으로 가설검증을 빠르게 하는 것이 중요](https://dis.qa/uoqKz5H)합니다. 하지만 모든 구성원이 목표 중심적으로 일하는 문화를 만드는 일이 너무 어렵습니다.

그래서 오늘은 매달 20개의 가설을 검증하는 무니스를 만나 가설검증 에피소드와 팀 문화를 만들어가는 방법에 대해 물어봤습니다. 많은 사람들이 더 잘 잤으면 하는 마음에 마루에 남아 본인들의 잠을 줄이는 무니스 팀의 이야기를 들려드립니다.
...
- **가설과 직관이 충돌한다면 무조건 실험을 통해 결과를 확인하세요.** 의외로 실험군과 대조군 모두 큰 변화가 없을 수도 있습니다. 그럼 중요하지 않은 곳에 쓸 시간을 아낄 수 있습니다.
...
![user journey.png](/images/uploads/disquiet-retention-ab-test-1.png "user journey.png")*// 위와 같이 UX를 변경한 후 리텐션과 결제율이 떨어졌다. 이후 롤백을 진행했고, 다시 지표가 회복됐다.*
...
그래서 원인을 찾다 결국 롤백을 했는데 다시 회복이 되더라고요. **알고보니 명상과 ASMR을 맨 앞에 배치했더니 유저들이 홈 화면을 보고서 우리 앱을 명상앱으로 인지한 것이 문제**였어요.

그때부터 A/B 테스트를 도입하기 시작했어요.

## 좋은 레슨런입니다. 기억에 남는 테스트가 있나요?

![1.png](/images/uploads/disquiet-retention-ab-test-2.png "1.png")한 번은 ‘온보딩 과정이 길수록 피로감을 느껴 이탈할 것이다’라는 가설을 세웠어요. 어떻게 보면 직관인거죠. 그래서 온보딩 과정을 더 길게 만들어봤습니다. 애니메이션과 질문을 더 추가해서 온보딩 프로세스를 1분 30초 이상 늘렸어요.

그랬더니 **결과적으로 지표가 10% 가량 상승**했습니다.
...
## 가설과 직관이 충돌할 때 고객의 니즈는 실험만이 알려줄 수 있다는 말씀입니다.

![2.png](/images/uploads/disquiet-retention-ab-test-3.png "2.png")맞아요. 우리가 모든 것을 예상할 수는 없으니까요. 그리고 이 실험이 가장 먼저 생각난 이유는 저희의 사고를 바꿔주었기 때문인데요, ‘어떻게 하면 더 편리하고 빠르게 유저경험을 설계할까?’가 아니라 ‘어떻게 하면 유저가 더 몰입할 수 있을까?’에 더 많은 고민을 하게 되었습니다.

이렇게 생각이 잡히고 나서 다시 퍼널을 보니 유저의 몰입을 방해하는 요소들이 보였고요. 하나씩 최적화시켜나갔고, 현재는 2분이 넘는 온보딩을 가지고 있지만 전보다 높은 전환율을 기록하고 있습니다.

## 유저의 편의성보다 유저의 몰입에 집중하는 것도 좋은 인사이트입니다.

창업가들이 A/B 테스트를 하면서 쉽게 놓칠 수 있는 부분에는 어떤 것이 있을까요?
...
## 그래서 저희가 얻었던 가장 큰 교훈은 실험군에 속한 사람들에게는 새로운 업데이트 소식을 진짜 열심히 알려야한다는 것이에요.

![3.png](/images/uploads/disquiet-retention-ab-test-4.png "3.png")수치 상으로도 실험군의 26%만이 새로운 기능을 사용하거든요. 실험군이 100명이 있으면 나머지 74명은 이런 업데이트가 있었는지 조차 몰라요.
...
무니스 팀의 에너지 레벨이 상당한 것 같습니다.

![老且锭.jpg](/images/uploads/disquiet-retention-ab-test-5.jpg "老且锭.jpg")*// 무니스 팀*
...
## 팀원 분들과의 라포 형성이 잘 되어있지 않으면 힘든 문화 같습니다.

굉장히 좋은 문화를 만들고 계십니다.

![팀 이미지 Large.png](/images/uploads/disquiet-retention-ab-test-6.png "팀 이미지 Large.png")*// 동네 골목 친구같은 무니스 팀 ㅎㅎ*
...
## 그리고 아쉽게도 이제 곧 마루를 나가십니다.

지금까지의 마루민 경험에 대해 들려주세요.

![Screenshot 2024-02-01 at 12.00.04 AM Large.png](/images/uploads/disquiet-retention-ab-test-7.png "Screenshot 2024-02-01 at 12.00.04 AM Large.png")*// 무니스 X 디스콰이엇*
...
## 마지막으로, 마루 지원서에 어떻게 Pay it forward할지 물어보는 문항이 있습니다.

많은 분들이 어려워하십니다. 어떻게 적으셨나요?
